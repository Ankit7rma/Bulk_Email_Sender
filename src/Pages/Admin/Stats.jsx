...
export const Stats = () => {
  ...
  const totalUsers = async () => {
    ...
    const data = await axios
      ...
      .then((data) => setAllUsers(data.data.totalUsers))
  ...
  const totalEmails = async () => {
    ...
    await axios
      ...
      .then((data) => setTotalEmails(data.data.totalEmails))
      .catch((err) => console.log(err));
  };
  ...
  const totalEmailLists = async () => {
    ...
    await axios
      ...
      .then((data) => setEmailLists(data.data.emailsList))
      .catch((err) => console.log(err));
  };
      ...
      <div className=" w-11/12 mx-auto">
        ...
        <div className=" mt-20 flex justify-around w-[1200px]">
          <LinesChart
            number={emailLists}
            totalNumber={5000}
            label1="Email Lists Created"
            label2="Email Lists limit"
          />
          <LinesChart
            number={tSentEmails}
            totalNumber={5000}
            label1="Total Email Sent"
            label2="Email Sent limit"
          />
        </div>
