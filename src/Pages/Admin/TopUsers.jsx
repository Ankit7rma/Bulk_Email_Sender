...
export const TopUsers = () => {
  ...
  const { authToken, allUsers, tSentEmails, emailLists } =
    ...
    <div className=" flex justify-around">
      ...
      <div className=" bg-black w-1/3 min-w-fit rounded-3xl py-4 my-20">
        <div className=" text-white flex items-end gap-4 mx-6 mb-6">
          <p className=" text-white font-bold text-4xl">Top 5 Users</p>
          <BarChart size={"40px"} />
        </div>
