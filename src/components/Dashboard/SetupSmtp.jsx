...
export const SetupSmtp = () => {
  ...
  const checkSMTP = async () => {
    ...
    await axios
      ...
      .catch((error) =>
        console.log("Error occured while fetching smtp details: ", error)
      );
  };
  useEffect(() => {
    checkSMTP();
        ...
        <div className="rounded-2xl bg-slate-700 flex flex-col w-[280px] h-[280px] gap-3 bg-opacity-80 p-6 px-9 overflow-hidden">
          ...
          <div>
            <p className=" text-white">
              <li>Use a dedicated SMTP server for Bulk Emailing</li>
              <li>
                If you don't know how to setup SMTP, Then refer how to use? Page
                to know eevrything about it
              </li>
            </p>
          </div>
        </div>
