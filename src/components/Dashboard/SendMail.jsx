...
export const SendMail = () => {
  ...
  return (
    <div className="">
      <div className="h-32 lg:h-[150px]"></div>
        ...
        <div className="relative file:flex flex-col rounded-3xl bg-slate-200 gap-3 w-[80%] lg:w-[600px] mx-auto p-3 z-[10] shadow-custom">
          ...
          <div className=" px-4 py-2 flex gap-4 ">
            ...
            <input
              ...
              className=" pr-2 py-1 bg-transparent rounded-lg w-[95%]"
            />
          </div>
          ...
          <div className=" px-4 py-2 flex gap-4 justify-between">
            ...
            <div>
              <select
                ...
                className=" rounded-lg bg-[#d9d9d9] text-gray-600 p-2 mt-4 w-full"
              >
          ...
          <div className=" flex items-center justify-end mt-1 mb-2 w-[97.5%]">
            <button
              ...
              className=" bg-[#7450BB] px-3 py-1 text-white rounded-md flex items-center gap-2"
            >
              Send <IoSend />
            </button>
          </div>
